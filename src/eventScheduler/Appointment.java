...
public class Appointment extends Event {
	...
	public Appointment(LocalDate date,String title, LocalTime time, Address address, String category) {
		this(date, title, time,"", 0, address, category );

	}

	public Appointment(LocalDate date,String title, LocalTime time, int duration, Address address, String category) {
		this(date, title, time,"", duration, address , category);

	}

	public Appointment(LocalDate date,String title, LocalTime time, String notes, Address address, String category) {
		this(date, title, time,"", 0, address, category );

	}

	public Appointment(LocalDate date,String title, LocalTime time, String notes, int duration, Address address, String category ) {
